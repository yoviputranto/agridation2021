        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{route('dlomba.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="name">Pelogin</label>
                            <input type="text" class="form-control" name="pelogin" placeholder="Pelogin" value="{{old('pelogin')}}" required>
                        </div>
                        <div class="form-group">
                            <label for="name">Tim</label>
                            <input type="text" class="form-control" name="tim" placeholder="Nama tim" value="{{old('tim')}}" required>
                        </div>
                        <div class="form-group">
