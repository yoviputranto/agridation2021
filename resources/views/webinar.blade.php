        ...
        <div class="w-100 pt-180 pb-180 page-title-wrap text-center black-layer opc5 position-relative">
            ...
            <div class="container">
                <div class="page-title-inner d-inline-block">
                    <h1 class="mb-0">Webinar Detail</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}" title="">Home</a></li>
                        <li class="breadcrumb-item active">Webinar Detail</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="event-detail-info w-100">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-sm-12 col-lg-6">
                                ...
                                <h2 class="mv-0">Peranan Teknologi sebagai Mekanisasi Pertanian dalam Mendukung Petani
                                    Milenial</h2>
                            </div>
                            <div class="col-md-12 col-sm-12 col-lg-6">
